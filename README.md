...
This project is inspired by the original [Pump.fun Solana Smart Contract](https://github.com/0xnightfly/EVM-Pumpfun-fourmeme-solidity-smart-contract.git), re-engineered for EVM chains starting with Monad.
